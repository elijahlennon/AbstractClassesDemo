    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            */
             ...
             */
            Car sonata = new Car() { HasTrunk = true, Make = "Hyundai", Model = "Sonata", Year = 2014 };

            Motorcycle ninja = new Motorcycle() { HasSideCar = false, Make = "Kawasaki", Model = "Ninja", Year = 2022 };

            Vehicle suv = new Car() { HasTrunk = false, Make = "Kia", Model = "Sportage", Year = 2020 };

            Vehicle sedan = new Car() { HasTrunk = true, Make = "Dodge", Model = "Dart", Year = 2015 };
